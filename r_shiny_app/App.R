...
setwd("C:/Users/UR82707255/OneDrive - RECOUV/R/R_raf")
...
load_data <- function() {
  ...
  df_existants <- read.csv(file = here::here("data_dpe_2_savoies_existants.csv"),
                           header = TRUE, sep = ";", dec = ".", fileEncoding = "UTF-8")
  df_neufs <- read.csv(file = here::here("data_dpe_2_savoies_neufs.csv"),
                       header = TRUE, sep = ";", dec = ".", fileEncoding = "UTF-8")
  df_adresses <- read.csv(file = here::here("adresses_73-74.csv"), 
                          header = TRUE, sep = ";", dec = ".", fileEncoding = "UTF-8")
  df_id_ban <- read.csv(file = here::here("resultats_dpe_identifiant_ban_73_74.csv"), 
                        header = TRUE, sep = ";", dec = ".", fileEncoding = "UTF-8")
